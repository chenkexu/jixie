...
public class ImgSelFragment extends Fragment implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.yuyh.library.imgsel.R.layout.fragment_img_sel, container, false);
        rvImageList = (RecyclerView) view.findViewById(com.yuyh.library.imgsel.R.id.rvImageList);
        btnAlbumSelected = (Button) view.findViewById(com.yuyh.library.imgsel.R.id.btnAlbumSelected);
        btnAlbumSelected.setOnClickListener(this);
        rlBottom = view.findViewById(com.yuyh.library.imgsel.R.id.rlBottom);
        viewPager = (CustomViewPager) view.findViewById(com.yuyh.library.imgsel.R.id.viewPager);
...
//                    folderPopupWindow.getListView().setDivider(new ColorDrawable(ContextCompat.getColor(getActivity(), com.yuyh.library.imgsel.R.color.bottom_bg)));
                    folderPopupWindow.getListView().setDivider(new ColorDrawable(ContextCompat.getColor(getActivity(), R.color.window_system_color)));
    ...
    private void showCameraAction() {
        ...
        if (cameraIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            Toast.makeText(getActivity(), getString(com.yuyh.library.imgsel.R.string.open_camera_failure), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        switch (requestCode) {
            case CAMERA_REQUEST_CODE:
                if (grantResults.length >= 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getActivity(), getString(com.yuyh.library.imgsel.R.string.permission_camera_denied), Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
