...
public interface ApiService {
  ...
  /*  4.//发票申请
    ...
    参数：orderId 订单ID  taitou 发票抬头  itemCheck  1为企业 2为个人  isdianzi 1为电子 2为纸制  price 价格  order_no 订单号 shibiehao 识别号 content 内容 email 邮箱 name 姓名 tel 电话 address 地址 des 备注
    */


    //发票申请
    @GET("/index.php/api/order/invoice?orderId")
    Observable<ApiResponse<Object>> insert_invoice(@QueryMap HashMap<String, Object> map);
}
