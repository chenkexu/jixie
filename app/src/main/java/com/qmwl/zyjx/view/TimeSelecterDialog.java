 ...
 */
public class TimeSelecterDialog extends AlertDialog implements
     ...
     * @param onClickButton
     */
    public TimeSelecterDialog(Context context, View contentView, MyDialog.onClickButton onClickButton) {
        super(context);
        this.cx = context;
        this.contentView = contentView;
    }

    public TimeSelecterDialog(Context context, View contentView, onClickButton listener) {
        super(context);
        this.cx = context;
        this.contentView = contentView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = LayoutInflater.from(cx).inflate(R.layout.timeselecter_dialog_layout,
                null);
