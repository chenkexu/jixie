...
public class ShoppingSpinnerListAdapter extends MyBaseAdapter<BlackBean> {
    ...
    public ShoppingSpinnerListAdapter(Context cx, ShoppingThreadActivity activity) {
        //实例化汉字转拼音类
        characterParser = CharacterParser.getInstance();
        comparator = new PinyinComparator();
        this.cx = cx;
    ...
    public ShoppingSpinnerListAdapter(boolean isDiQu, ShoppingThreadActivity activity) {
        //实例化汉字转拼音类
        characterParser = CharacterParser.getInstance();
        comparator = new PinyinComparator();
        this.isDiQu = isDiQu;
